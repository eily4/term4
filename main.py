...
from database import GradeSearch, GradeInsert, StudentInsert, StudentSelect,StudentSearch, StudentGet, StudentUpdate
...
def on_double_click(event):
    ...
    for g in grd:
        tree.insert("",1,text='',values=(g[2],g[3],g[4],g[5],g[6]))
